...
class StandaloneExtension(CWrapPlugin):
    ...
    TYPE_UNPACK = {
        ...
        'THByteTensor*': Template('THPByteTensor_CData((THPByteTensor*)$arg)'),
        ...
        'THCudaByteTensor*': Template('THCPByteTensor_CData((THCPByteTensor*)$arg)'),
    ...
    TYPE_CHECK = {
        ...
        'THCudaByteTensor*': Template('(PyObject*)Py_TYPE($arg) == THCPByteTensorClass'),
...
PyObject * $name(PyObject *_unused, PyObject *args)
{
  ...
  END_HANDLE_TH_ERRORS
    ...
    TYPE_NAMES = {
        ...
        'THCudaByteTensor*': 'torch.cuda.ByteTensor',
